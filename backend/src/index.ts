...
app.get('/', (req: Request, res: Response) => {
  ...
  res.status(200).json({ 
    ...
    endpoints: {
      ...
      'POST /api/vendors/:id/evidence': 'Upload evidence files',
      'GET /api/vendors/:id/evidence': 'Get vendor evidence files',
      'GET /api/vendors/:id/evidence/count': 'Get evidence count',
      'GET /api/vendors/:id/evidence/:fileId/download': 'Download evidence',
