  ...
  try {
    ...
    if (questions.length > 50) {
      return {
        ...
        body: JSON.stringify({ error: 'Maximum 50 questions allowed per batch request' })
      };
    }
      ...
      try {
        if (!question || typeof question !== 'string') {
          results.push({
            ...
            answer: 'We couldn\'t generate an answer at this time—please try again.',
            success: false,
        ...
        // Find relevant data and generate answer
    ...
    return {
      ...
      body: JSON.stringify({ error: error.message || 'Error processing batch questions' })
    };
  }
};
